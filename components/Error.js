...
const Error = (props) => {
  return (
    <div className="flex justify-center m-auto w-full max-w-screen-lg" role="alert">
      <div className="m-8 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative flex items-center" role="alert">
        <span className="pr-1">
        ...
        <strong className="pr-1 font-semibold">Error:</strong>
